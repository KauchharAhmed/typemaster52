                  ...
                  <div class="user_heading user_heading_bg" style="background-image: url('public/assets/img/gallery/Image10.jpg');background-size:cover;">
                    <div class="bg_overlay">
                        ...
                        <div class="user_heading_avatar">
                            <div class="thumbnail">
                                <img src="{{ URL::to('public/images/user') }}/{{ $adminQuery->image }}" alt="Admin"/>
                            </div>
                        </div>
                        
                        <div class="user_heading_content">
                            <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $adminQuery->first_name.' '.$adminQuery->last_name; ?></span><span class="sub-heading">Admin</span></h2>
                            <ul class="user_stats">
                                <li>
              ...
              <?php 
               ...
               ?>
                <div class="md-card-content large-padding">
                    {!! Form::open(['url' => 'userProfileUpdateInfo','method' => 'post' , 'class'=> 'uk-form-stacked' , 'id'=> 'form_validation' , 'enctype' => 'multipart/form-data' ]) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                          <div class="uk-width-medium-1-1">
                            <div class="uk-form-row">
                                <label>First Name<span class="req">*</span></label>
                                <input type="text" name="firstName" required class="md-input" value="<?php echo $profile->first_name; ?>" />
                            </div>

                            <div class="uk-form-row">
                                <label>Last Name<span class="req">*</span></label>
                                <input type="text" name="lastName" required class="md-input" value="<?php echo $profile->last_name; ?>" />
                            </div>
