...
<div id="page_content">
        <div id="page_content_inner">
            <!-- large chart -->
			<h3 class="heading_b uk-margin-bottom">UNAPPROVED EXAM FEE TRANSACTION</h3>
                        ...
                        <tbody>
                        	<?php 
                              ...
                              <td><?php echo $value->transanction_id ; ?></td>
              								...
              								<td><a class="md-btn md-btn-danger md-btn-wave-light waves-effect waves-button waves-light" href="{{URL::to('rejectExamFee/'.$value->id)}}">Reject</a></td>
              							</tr>
                          <?php } ?>
                        </tbody>
                    </table>
